...
class Open_Maps {
	...
	public function __construct() {
		if ( defined( 'OPEN_MAPS_VERSION' ) ) {
			$this->version = OPEN_MAPS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'open-maps';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Open_Maps_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Open_Maps_Public( $this->get_plugin_name(), $this->get_version() );
